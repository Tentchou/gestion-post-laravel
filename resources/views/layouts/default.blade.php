...
<body class="antialiased pt-10 pb-16 md:pb-32">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <nav x-data="{ open: false }" x-cloak class="relative">
                ...
                @auth
                   ...
                   {{-- ici , nous affichons la gestion post si on est admin, et non si non --}}
                   ...
                   <li><a href="{{ route('logouts') }}" @click.prevent="$refs.logout.submit()"  class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Deconnexion</a></li>

                   <form x-ref="logout" action="{{ route('logouts') }}" method="post" class="hidden">
                    @csrf


                   </form>
               @else
                    <li><a href="{{ route('logins') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 bg-green-500 rounded">Connexion</a></li>
                    <li>
                ...
                <ul class="hidden md:flex space-x-12 font-semibold">
                    <li><a href="{{ route('logins') }}">Connexion</a></li>
                    <li>
        ...
        {{-- gestion de notre session pour afficher un message --}}
        @if (session('status'))
